...
public class BallFollowerCommand extends CommandBase {
  ...
  public void execute() {
   ...
   /* if(vision.getCenterX() < 70){ //left
    ...
    double turn = MathR.proportion(VisionSubsystem.getCenterX()-80, 0.26, 80, 10, 0.35);//MathR.limit((VisionSubsystem.getCenterX()-80)/80,-0.4,0.4);
  ...
  public boolean isFinished() {
    return Math.abs(VisionSubsystem.getCenterX() - 80) < 5;
  }
}
